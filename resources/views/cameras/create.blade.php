...
<div class="container">
    ...
    <form action="{{route('cameras.store')}}" method="post" enctype="multiplart/form-data">
        @csrf
        <br>
        <div class="row mb-3">
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4">
                ...
                <input class="form-control" type="number" name="Screensize" id="" placeholder="Tamaño de la pantalla"
                    required>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 col-xl-4">
                ...
                <input class="form-control" type="text" name="ISOsensitivity" id="" placeholder="ISO de conectividad"
                    required>
            </div>
