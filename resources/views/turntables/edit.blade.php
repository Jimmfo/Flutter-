...
<input class="form-control" type="text" name="Playbackspeeds" value="{{$turntable->Playbackspeeds}}" required>
</div>
<div class="col-xs-12 col-sm-4 col-md-4 col-xl-4">
<label for="">Salidas de audio:</label>
<input  class="form-control" type="number" name="Audiooutputs" value="{{$turntable->Audiooutputs}}" required>
</div>
...
<input class="form-control" type="text" name="TurntableMaterial" value="{{$turntable->TurntableMaterial}}">
</div>
...
<textarea class="form-control" name="Description" id="" cols="30" rows="10" required>{{$turntable->Description}}</textarea>
<br>
