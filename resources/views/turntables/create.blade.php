    ...
    <form action="{{route('turntables.store')}}" method="post">
        ...
        <div class="row ">
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-5 col-md-4 col-xl-5">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-5 col-md-5 col-xl-5">
                    ...
                    <input class="form-control" type="text" name="Playbackspeeds" id=""
                        placeholder="Velocidades de reproducción" required>
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5 col-xl-5">
                    <label for="">Salidas de audio:</label>
                    <input class="form-control" type="number" name="Audiooutputs" id="" placeholder="Salidas de audio"
                        required>
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5 col-xl-5">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-5 col-md-5 col-xl-5">
                    ...
                    <input class="form-control" type="text" name="Recording" id="" placeholder="Función de grabación"
                        required>
                </div>
                <div class="col-xs-12 col-sm-5 col-md-5 col-xl-5">
                    <label for="">Material de la bandeja giratoria:</label>
                    <input class="form-control" type="text" name="TurntableMaterial" id=""
                        placeholder="Material de la bandeja giratoria" required>
                </div>
            ...
            <div>
                ...
                <textarea class="form-control" name="Description" id="" cols="10" rows="10" required></textarea>
                <br>
